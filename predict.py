...
path_of_image = commands.image_dir
path_of_model = commands.model
top_k = commands.top_k
classes = commands.classes

image_size = 200

# Creating process_image function
...
def predict(path_of_image, model, top_k = 5):
...
if __name__ == "__main__":
    predict(path_of_image,model,top_k)